...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      if (!name) return interaction.reply({ content: `**( ❌ )** Digite um nome válido.`, ephemeral: true }).catch(e => { });
      let res;
      try {
