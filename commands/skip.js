...
module.exports = {
  name: "pular",
  description: "Pule a música que está sendo reproduzida.",
  permissions: "0x0000000000000800",
  options: [{
    name: "number",
    description: "mencione quantas músicas você deseja pular.",
...
try {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(success ? ` **PULADO:** _${old.name}_` : '**( ❌ )** A fila está vazia.')
    .setTimestamp();
